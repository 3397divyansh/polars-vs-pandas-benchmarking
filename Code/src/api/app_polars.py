...
from src.services import ops_polars

app = FastAPI(
    title="Polars E-Commerce Benchmark API",
    description="Lazy/Multithreaded Polars execution of standard data engineering operations.",
    version="2.0.0"
)
...
def get_heavy_join():
    ...
    try:
        return ops_polars.benchmark_heavy_join()
...
def get_aggregations():
    ...
    try:
        return ops_polars.benchmark_aggregations()
    except Exception as e:
        raise HTTPException(status_code=500, detail=f"Polars processing error: {str(e)}")
...
def get_window_functions():
    ...
    try:
        return ops_polars.benchmark_window_functions()
    except Exception as e:
        raise HTTPException(status_code=500, detail=f"Polars processing error: {str(e)}")
...
def get_string_processing():
    ...
    try:
        return ops_polars.benchmark_string_processing()
    except Exception as e:
        raise HTTPException(status_code=500, detail=f"Polars processing error: {str(e)}")
...
def get_time_series():
    ...
    try:
        return ops_polars.benchmark_time_series()
    except Exception as e:
        raise HTTPException(status_code=500, detail=f"Polars processing error: {str(e)}")
...
def get_null_imputation():
    ...
    try:
        return ops_polars.benchmark_null_imputation()
    except Exception as e:
        raise HTTPException(status_code=500, detail=f"Polars processing error: {str(e)}")
